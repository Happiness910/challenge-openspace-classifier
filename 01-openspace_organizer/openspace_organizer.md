...
- Team challenge : `Solo`
- Duration: `2 days`
- Deadline: `29/05/26 4:00 PM`
- Show and tell: Monday during stand-up. 
...
Make sure that you understand the concept of OOP, as this project will make intensive use of it. We will do it in two steps:

1. **Complete the notebook guide:** This will help you develop the program logic, and test progressively as you build your solution.
2. **Restructure your code as a Python project (using scripts):** 
...
- `notebook_guide.ipynb`: You will use this as a first step to build and test your code logic before jumping into OOP! We have provided a sample. You can copy this file in your local repository as a starting point.
...
#### 1. Create a first version of the project in a your notebook guide

Here is a [guide](notebook_guide.ipynb)! Add it to your repo and follow the steps. You will create three objects a seat, a table (made of seats), and an open space (made of tables).
...
![You've got this!](https://media.giphy.com/media/BcCoMy2A0eYELrRZ6O/giphy.gif)
>>>>>>> e24178647048828277b1571a3c64b97acd5cdecc
